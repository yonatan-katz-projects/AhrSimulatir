...
static AhrSimApplication* g_pApp;
...
//i n our (global) application object.
...
int glutmain(int argc, char **argv, int width, int height, 
	const char* title, AhrSimApplication* pApp) 
{
